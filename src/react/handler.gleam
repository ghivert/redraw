...
import react/event/animation.{type AnimationEvent}
import react/event/clipboard.{type ClipboardEvent}
import react/event/composition.{type CompositionEvent}
import react/event/drag.{type DragEvent}
import react/event/focus.{type FocusEvent}
import react/event/input.{type InputEvent}
import react/event/keyboard.{type KeyboardEvent}
import react/event/mouse.{type MouseEvent}
import react/event/pointer.{type PointerEvent}
import react/event/touch.{type TouchEvent}
import react/event/transition.{type TransitionEvent}
import react/event/wheel.{type WheelEvent}
