...
pub fn style(attrs: List(Attribute), content) -> Element {
  let props = to_props(attrs)
  redraw.jsx(
    type_: "style",
    props:,
...
pub fn title(attrs: List(Attribute), content) -> Element {
  let props = to_props(attrs)
  redraw.jsx(
    type_: "title",
    props:,
...
pub fn slot(attrs: List(Attribute), children: List(Element)) -> Element {
  let props = to_props(attrs)
