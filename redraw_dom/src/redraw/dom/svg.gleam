...
pub fn clip_path(attrs: List(Attribute), children: List(Element)) -> Element {
  let props = to_props(attrs)
...
pub fn desc(attrs: List(Attribute), children: List(Element)) -> Element {
  let props = to_props(attrs)
...
pub fn discard(attrs: List(Attribute), children: List(Element)) -> Element {
  let props = to_props(attrs)
...
pub fn fe_blend(attrs: List(Attribute), children: List(Element)) -> Element {
  let props = to_props(attrs)
...
/// [Documentation](https://developer.mozilla.org/docs/Web/SVG/Element/feElementTransfer)
pub fn fe_component_transfer(
  attrs: List(Attribute),
  children: List(Element),
) -> Element {
  let props = to_props(attrs)
  redraw.jsx(type_: "feElementTransfer", props:, children:, convert_children:)
}

/// [Documentation](https://developer.mozilla.org/docs/Web/SVG/Element/feComposite)
pub fn fe_composite(attrs: List(Attribute), children: List(Element)) -> Element {
  let props = to_props(attrs)
...
pub fn fe_flood(attrs: List(Attribute), children: List(Element)) -> Element {
  let props = to_props(attrs)
...
pub fn fe_func_a(attrs: List(Attribute), children: List(Element)) -> Element {
  let props = to_props(attrs)
...
pub fn fe_func_b(attrs: List(Attribute), children: List(Element)) -> Element {
  let props = to_props(attrs)
...
pub fn fe_func_g(attrs: List(Attribute), children: List(Element)) -> Element {
  let props = to_props(attrs)
...
pub fn fe_func_r(attrs: List(Attribute), children: List(Element)) -> Element {
  let props = to_props(attrs)
...
pub fn fe_image(attrs: List(Attribute), children: List(Element)) -> Element {
  let props = to_props(attrs)
...
pub fn fe_merge(attrs: List(Attribute), children: List(Element)) -> Element {
  let props = to_props(attrs)
...
pub fn fe_merge_node(attrs: List(Attribute), children: List(Element)) -> Element {
  let props = to_props(attrs)
...
pub fn fe_morphology(attrs: List(Attribute), children: List(Element)) -> Element {
  let props = to_props(attrs)
...
pub fn fe_offset(attrs: List(Attribute), children: List(Element)) -> Element {
  let props = to_props(attrs)
...
pub fn fe_spot_light(attrs: List(Attribute), children: List(Element)) -> Element {
  let props = to_props(attrs)
...
pub fn fe_tile(attrs: List(Attribute), children: List(Element)) -> Element {
  let props = to_props(attrs)
...
pub fn fe_turbulence(attrs: List(Attribute), children: List(Element)) -> Element {
  let props = to_props(attrs)
...
pub fn filter(attrs: List(Attribute), children: List(Element)) -> Element {
  let props = to_props(attrs)
...
pub fn hatch(attrs: List(Attribute), children: List(Element)) -> Element {
  let props = to_props(attrs)
...
pub fn hatchpath(attrs: List(Attribute), children: List(Element)) -> Element {
  let props = to_props(attrs)
...
pub fn image(attrs: List(Attribute), children: List(Element)) -> Element {
  let props = to_props(attrs)
...
pub fn mask(attrs: List(Attribute), children: List(Element)) -> Element {
  let props = to_props(attrs)
...
pub fn metadata(attrs: List(Attribute), children: List(Element)) -> Element {
  let props = to_props(attrs)
...
pub fn pattern(attrs: List(Attribute), children: List(Element)) -> Element {
  let props = to_props(attrs)
...
pub fn polygon(attrs: List(Attribute), children: List(Element)) -> Element {
  let props = to_props(attrs)
...
pub fn polyline(attrs: List(Attribute), children: List(Element)) -> Element {
  let props = to_props(attrs)
...
pub fn set(attrs: List(Attribute), children: List(Element)) -> Element {
  let props = to_props(attrs)
...
pub fn switch(attrs: List(Attribute), children: List(Element)) -> Element {
  let props = to_props(attrs)
...
pub fn symbol(attrs: List(Attribute), children: List(Element)) -> Element {
  let props = to_props(attrs)
...
pub fn text_path(attrs: List(Attribute), children: List(Element)) -> Element {
  let props = to_props(attrs)
