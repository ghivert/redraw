...
@external(javascript, "./event.ffi.mjs", "bubbles")
...
@external(javascript, "./event.ffi.mjs", "cancelable")
...
@external(javascript, "./event.ffi.mjs", "defaultPrevented")
...
@external(javascript, "./event.ffi.mjs", "eventPhase")
...
@external(javascript, "./event.ffi.mjs", "isTrusted")
...
@external(javascript, "./event.ffi.mjs", "timeStamp")
